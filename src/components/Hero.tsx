  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-dark-900 dark:via-dark-800 dark:to-dark-900 pt-16 transition-colors relative overflow-hidden">
      ...
      <div className="text-center px-4 relative z-10">
        ...
        <a
          href="#projetos"
          className="inline-flex items-center justify-center px-6 py-3 text-base font-medium rounded-md text-white bg-gradient-to-r from-accent-blue to-accent-purple hover:opacity-90 transition-all duration-300 transform hover:scale-105 animate-glow"
        >
          Ver Projetos
        </a>
